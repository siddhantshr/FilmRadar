...
const Carousel = () => {
    return (
        <div id="default-carousel" className="relative w-full" data-carousel="slide">
            <div className="relative h-128 md:h-[64vh] lg:h-[75vh] overflow-hidden rounded-base">
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/thedictator.jpg" className="absolute inset-0 w-full h-full object-cover" alt="..."></img>
                </div>
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/mitfr.jpg" className="absolute inset-0 w-full h-full object-cover" alt="..."></img>
                </div>
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/grayman.jpg" className="absolute inset-0 w-full h-full object-cover" alt="..."></img>
                </div>
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/topgun.jpg" className="absolute inset-0 w-full h-full object-cover" alt="..."></img>
                </div>
                <div className="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/popes-exorcist.jpg" className="absolute inset-0 w-full h-full object-cover" alt="..."></img>
                </div>
            </div>
